...
Error::ERROR errors[ERROR_MAX_ENTRY] =
{
	...
	ERROR_ENTRY(131, "[Лексическая] Присутствует незакрытый строчный литерал"),
	ERROR_ENTRY(132, "[Лексическая] Переменная типа PINT выходит за рамки допустимого значения"),
	ERROR_ENTRY(133, "[Лексическая] Пустая строка(требуется иницилизация или удаление её попытки)"),
	ERROR_ENTRY(134, "[Лексическая] Длинна индефикатора больше допустимого"), 
	...
	ERROR_ENTRY(302, "[Cемантическая] Неверное количество или несоответствие типов параметров в вызываемой функции"),
	ERROR_ENTRY(303, "[Cемантическая] "),
	ERROR_ENTRY(304, "[Cемантическая] Запрещено присваивать значение функции"),
	ERROR_ENTRY(305, "[Cемантическая] Несоответсвие присваимаего типа данных(наличие отличного типа данных в выражении)"),
	...
	ERROR_ENTRY(312, "[Cемантическая] Недопустимое значение переменной типа PINT"),
	ERROR_ENTRY(313, "[Cемантическая] Попытка сравнить разные типы данных"),
	ERROR_ENTRY(314, "[Cемантическая] Недопустимое значение переменной типа PSTRING"),
